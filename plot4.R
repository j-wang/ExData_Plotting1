...
par(mfrow=c(2,2))  # settings to have 4 plots together
# First Plot
plot(x=final_dat$datetime, y=final_dat$Global_active_power, type="l", xlab="", ylab="Global Active Power")

# Second Plot
plot(x=final_dat$datetime, y=final_dat$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
# Fourth Plot
plot(x=final_dat$datetime, y=final_dat$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
